...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('employees', function (Blueprint $table) {
            ...
            $table->string('nationality_certificate_authority_issuing','30')->nullable();
            ...
            $table->string('housing_card_issuing_authority','30')->nullable();
            ...
            $table->string('certificate_of_appointment_college_name','30')->nullable();
