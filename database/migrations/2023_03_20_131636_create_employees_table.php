...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('employees', function (Blueprint $table) {
            ...
            $table->string('national_card_issuing_authority','30')->nullable();
            ...
            $table->string('civil_status_issuer','30')->nullable();
            $table->string('nationality_certificate_number','20')->nullable();
            $table->string('nationality_certificate_authority_issuing','20')->nullable();
            ...
            $table->string('housing_card_issuing_authority','20')->nullable();
            ...
            $table->string('certificate_of_appointment_academic_achievement','20')->nullable();
            $table->string('certificate_of_appointment','20')->nullable();
            $table->string('certificate_of_appointment_graduation_year','9')->nullable();
            $table->string('certificate_of_appointment_university_institute_school_name','30')->nullable();
            $table->string('certificate_of_appointment_college_name','20')->nullable();
            ...
            $table->string('last_name_of_the_university','20')->nullable();
            $table->string('last_university_institute_school_name','30')->nullable();
            $table->string('last_name_of_the_college','20')->nullable();
            $table->string('last_major','20')->nullable();
            $table->integer('last_certificate_of_appointment_mark')->nullable();
            $table->boolean('is_scientific_title')->nullable();
            ...
            $table->boolean('is_political_dismissal')->nullable();
