            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div class=" mx-4 my-4 w-full">
                    ...
                    <div class=" mx-4 my-4 w-full">
                                    ...
                                    <p id="is_main_school" class="w-full h-9 block mt-1" type="text" name="is_main_school">
                                    نعم
                                    </p>    
                                    @else
                                    <p id="is_main_school" class="w-full h-9 block mt-1" type="text" name="is_main_school">
                    ...
                    <div class=" mx-4 my-4 w-full">
                                    ...
                                    <p id="main_section_id" class="w-full h-9 block mt-1" type="text" name="main_section_id">
                    ...
                    <div class=" mx-4 my-4 w-full">
                                    ...
                                    <p id="established_year" class="w-full h-9 block mt-1" type="text" name="established_year">
                    ...
                    <div class=" mx-4 my-4 w-full">
                                    ...
                                    <p id="school_property_id" class="w-full h-9 block mt-1" type="text" name="school_property_id">
                    ...
                    <div class=" mx-4 my-4 w-full">
                                    ...
                                    <p id="school_time_id" class="w-full h-9 block mt-1" type="text" name="school_time_id">
                    ...
                    <div class=" mx-4 my-4 w-full">
                                    ...
                                    <p id="school_invironment_id" class="w-full h-9 block mt-1" type="text" name="school_invironment_id">
                    ...
                    <div class=" mx-4 my-4 w-full">
                                    ...
                                    <p id="school_gender_id" class="w-full h-9 block mt-1" type="text" name="school_gender_id">
                    ...
                    <div class=" mx-4 my-4 w-full">
                                    ...
                                    <p id="school_stage_id" class="w-full h-9 block mt-1" type="text" name="school_stage_id">
                    ...
                    <div class=" mx-4 my-4 w-full">
                                    ...
                                    <p id="personale_design_number" class="w-full h-9 block mt-1" type="text" name="personale_design_number">
                    ...
                    <div class=" mx-4 my-4 w-full">
                                    ...
                                    <p id="male_pupils_number" class="w-full h-9 block mt-1" type="text" name="male_pupils_number">
                    ...
                    <div class=" mx-4 my-4 w-full">
                                    ...
                                    <p id="female_pupils_number" class="w-full h-9 block mt-1" type="text" name="female_pupils_number">
                    ...
                    <div class=" mx-4 my-4 w-full">
                                    ...
                                    <p id="occupied_rooms_number" class="w-full h-9 block mt-1" type="text" name="occupied_rooms_number">
                    ...
                    <div class=" mx-4 my-4 w-full">
                                    ...
                                    <p id="filed_classes_number" class="w-full h-9 block mt-1" type="text" name="filed_classes_number">
                    ...
                    <div class=" mx-4 my-4 w-full">
                                    ...
                                    <p id="desks_number" class="w-full h-9 block mt-1" type="text" name="desks_number">
                                        {{ $school->desks_number}}
                                    </p>       
                    </div>
                    ...
                    <div class=" mx-4 my-4 w-full">
                                    ...
                                    <p id="is_there_airconditions" class="w-full h-9 block mt-1" type="text" name="is_there_airconditions">
                                    نعم
                                    </p>    
                                    @else
                                    <p id="is_there_airconditions" class="w-full h-9 block mt-1" type="text" name="is_there_airconditions">
                    ...
                    <div class=" mx-4 my-4 w-full">
                                    ...
                                    <p id="is_special_education" class="w-full h-9 block mt-1" type="text" name="is_special_education">
                                    نعم
                                    </p>    
                                    @else
                                    <p id="is_special_education" class="w-full h-9 block mt-1" type="text" name="is_special_education">
                    ...
                    <div class=" mx-4 my-4 w-full">
                                    ...
                                    <p id="is_computer_available" class="w-full h-9 block mt-1" type="text" name="is_computer_available">
                                    نعم
                                    </p>    
                                    @else
                                    <p id="is_computer_available" class="w-full h-9 block mt-1" type="text" name="is_computer_available">
                    ...
                    <div class=" mx-4 my-4 w-full">
                                    ...
                                    <p id="is_teaching_computer" class="w-full h-9 block mt-1" type="text" name="is_teaching_computer">
                                    نعم
                                    </p>    
                                    @else
                                    <p id="is_teaching_computer" class="w-full h-9 block mt-1" type="text" name="is_teaching_computer">
                    ...
                    <div class=" mx-4 my-4 w-full">
                                    <x-input-label for="is_teaching_other_languages" class="w-full mb-1" :value="__('word.is_teaching_other_languages')" />
                                    @if ($school->is_teaching_other_languages == 2)
                                    <p id="is_teaching_other_languages" class="w-full h-9 block mt-1" type="text" name="is_teaching_other_languages">
                                    نعم
                                    </p>    
                                    @else
                                    <p id="is_teaching_other_languages" class="w-full h-9 block mt-1" type="text" name="is_teaching_other_languages">
                    ...
                    <div class=" mx-4 my-4 w-full">
                                    ...
                                    <p id="is_electronic_classes" class="w-full h-9 block mt-1" type="text" name="is_electronic_classes">
                                    نعم
                                    </p>    
                                    @else
                                    <p id="is_electronic_classes" class="w-full h-9 block mt-1" type="text" name="is_electronic_classes">
                    ...
                    <div class=" mx-4 my-4 w-full">
                                    ...
                                    <p id="classrooms_number" class="w-full h-9 block mt-1" type="text" name="classrooms_number">
                    ...
                    <div class=" mx-4 my-4 w-full">
                                    ...
                                    <p id="is_predicated" class="w-full h-9 block mt-1" type="text" name="is_predicated">
                                    نعم
                                    </p>    
                                    @else
                                    <p id="is_predicated" class="w-full h-9 block mt-1" type="text" name="is_predicated">
