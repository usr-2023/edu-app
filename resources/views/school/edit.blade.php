                        ...
                        <form method="POST" action="{{ route('school.update', $school->url_address) }}">
                            ...
                            <div class=" mx-4 my-4 w-full">
                                    ...
                                    <x-text-input id="counting_number" class="w-full block mt-1" type="text"
                                        name="counting_number" value="{{ old('counting_number')?? $school->counting_number }}" />
                            ...
                            <div class=" mx-4 my-4 w-full">
                                    ...
                                    <select id="province_id" class="w-full block mt-1 "
                                        name="province_id">
                            ...
                            <div class=" mx-4 my-4 w-full">
                                    ...
                                    <x-text-input id="established_year" class="w-full block mt-1" type="text"
                                        name="established_year" value="{{ old('established_year')?? $school->established_year }}" />
                            ...
                            <div class=" mx-4 my-4 w-full">
                                ...
                                <div class=" mx-4 my-4 w-full">
                                    ...
                                    <select id="duality_id" class="w-full block mt-1 "
                                        name="duality_id">
                                ...
                                <div class=" mx-4 my-4 w-full">
                                    ...
                                    <select id="school_time_id" class="w-full block mt-1 "
                                        name="school_time_id">
                                ...
                                <div class=" mx-4 my-4 w-full">
                                    ...
                                    <select id="school_gender_id" class="w-full block mt-1 "
                                ...
                                <div class=" mx-4 my-4 w-full">
                                    ...
                                    <select id="school_stage_id" class="w-full block mt-1 "
                            ...
                            <div class="flex">
                                <div class=" mx-4 my-4 w-full">
                                    ...
                                    <x-text-input id="personale_design_number" class="w-full block mt-1" type="text"
                                        name="personale_design_number" value="{{ old('personale_design_number')?? $school->personale_design_number }}" />
                                ...
                                <div class=" mx-4 my-4 w-full" id="mp">
                                    ...
                                    <x-text-input id="male_pupils_number" class="w-full block mt-1" type="text"
                                        name="male_pupils_number" value="{{ old('male_pupils_number')?? $school->male_pupils_number }}" />
                                ...
                                <div class=" mx-4 my-4 w-full" id="fp">
                                    ...
                                    <x-text-input id="female_pupils_number" class="w-full block mt-1" type="text"
                                        name="female_pupils_number" value="{{ old('female_pupils_number')?? $school->female_pupils_number }}" />
                                ...
                                <div class=" mx-4 my-4 w-full">
                                    ...
                                    <x-text-input id="occupied_rooms_number" class="w-full block mt-1" type="text"
                                        name="occupied_rooms_number" value="{{ old('occupied_rooms_number')?? $school->occupied_rooms_number }}" />
                                ...
                                <div class=" mx-4 my-4 w-full">
                                    ...
                                    <x-text-input id="filed_classes_number" class="w-full block mt-1" type="text"
                                        name="filed_classes_number" value="{{ old('filed_classes_number')?? $school->filed_classes_number }}" />
                                ...
                                <div class=" mx-4 my-4 w-full">
                                    ...
                                    <x-text-input id="desks_number" class="w-full block mt-1" type="text"
                                        name="desks_number" value="{{ old('desks_number')?? $school->desks_number }}" />
                                ...
                                <div class=" mx-4 my-4 w-full">
                                    ...
                                    <select id="is_there_airconditions" class="w-full block mt-1 "name="is_there_airconditions">
                                    ...
                                    <select id="is_special_education" class="w-full block mt-1 "name="is_special_education">
                                ...
                                <div class=" mx-4 my-4 w-full">
                                    ...
                                    <select id="is_computer_available" class="w-full block mt-1 "name="is_computer_available">
                                ...
                                <div class=" mx-4 my-4 w-full">
                                    ...
                                    <select id="is_teaching_computer" class="w-full block mt-1 "name="is_teaching_computer">
                                ...
                                <div class=" mx-4 my-4 w-full">
                                    ...
                                    <select id="is_teaching_other_languages" class="w-full block mt-1 "name="is_teaching_other_languages">
                                    ...
                                    <select id="is_electronic_classes" class="w-full block mt-1 "name="is_electronic_classes">
                                    ...
                                    <x-text-input id="classrooms_number" class="w-full block mt-1" type="text"
                                        name="classrooms_number" value="{{ old('classrooms_number')?? $school->classrooms_number }}" />
