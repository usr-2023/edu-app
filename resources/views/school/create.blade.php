                        ...
                        <form method="POST" action="{{ route('school') }}">
                            ...
                            <div class=" mx-4 my-4 w-full">
                                ...
                                <div class=" mx-4 my-4 w-full">
                                    ...
                                    <select id="is_main_school" class="w-full block mt-1 "
                                        name="is_main_school">
                            ...
                            <div class=" mx-4 my-4 w-full">
                                    ...
                                    <select id="main_section_id" class="w-full block mt-1 "
                            ...
                            <div class=" mx-4 my-4 w-full">
                                ...
                                <div class=" mx-4 my-4 w-full">
                                    ...
                                    <x-text-input id="personale_design_number" class="w-full block mt-1" type="text"
                                        name="personale_design_number" value="{{ old('personale_design_number') }}" />
                                ...
                                <div class=" mx-4 my-4 w-full">
                                    ...
                                    <select id="is_predicated" class="w-full block mt-1 "
                                        name="is_predicated">
